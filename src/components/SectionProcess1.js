  ...
  return (
    <section className={styles.sectionProcess}>
      <div className={styles.container}>
        {[
          { id: "01", title: "FINANCIAL EDUCATION", text: "Through her UNCUT channel, she breaks down the often-overlooked truths about business, life, and mindset, providing real, honest insights aimed at changing the way you think and succeed." },
          { id: "02", title: "CINEMA-BASED LESSONS", text: "Through her main YouTube channel, Kelly turns life’s toughest situations into powerful, motivational mini-movies that inspire, teach, and remind us all that growth comes from helping others." },
          ...
          { id: "05", title: "The BIG THING", text: "Finding her first major success in the trading industry, Kelly has dedicated her time and resources to revolutionizing its education. She’s now building an innovative EdTech company to make that transformation sustainable and accessible for all." }
        ].map((block, index) => (
          <motion.div
            key={block.id}
